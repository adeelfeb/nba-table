 ...
 * Checked in: email subject, email body, welcome text, main message, button text,
 * second button text, reply prompt label (and recipient name).
...
module.exports = [
  ...
  'sexy', 'sex', 'nude', 'nudes', 'naked', 'horny', 'fetish', 'adult only',
  // Spam / phishing related
  'viagra', 'cialis', 'casino', 'lottery winner', 'click here free', 'congratulations winner',
  'nigerian prince', 'wire transfer', 'urgent money', 'free money',
];
