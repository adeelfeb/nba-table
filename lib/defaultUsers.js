...
// Default password for development/testing only
// In production, this should be set via environment variable or changed immediately after creation
const DEFAULT_HR_PASSWORD = process.env.DEFAULT_HR_PASSWORD || 'pass123';
